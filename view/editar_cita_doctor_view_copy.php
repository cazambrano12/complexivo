            ...
            <div class="card border-info mt-3 card-responsive">
                <div class="card-header"><h4 class="card-title text-center"><b>DATOS CITA</b></h4></div>
                    ...
                    <form class="p-4" method="POST" action="../controller/editar_conf_cita_doctor_controller.php">
                            ...
                            <div class="mb-3">
                            <label class="form-label"><b>Registrar medicamentos:</b></label>
                                <a onclick="" class="text-danger" href="http://localhost/app/view/medicinas_doctor_view.php?consulta=&enviar=?id_cita=<?php echo $cita_doctor_editar->id_cita; ?>">
                                <button type="button" class="btn btn-outline-info"><i class="bi bi-trash"></i></button></a>
