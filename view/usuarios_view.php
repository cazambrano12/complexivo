...
<!--Vista de usuarios, controlador conecta con BBDD y muestra información-->
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card border-info mt-3 card-responsive">
                <div class="card-header"><h4 class="card-title"><b>USUARIOS</b></h4></div>
                    <div class="card-body">
                    ...
                    <a href="http://localhost/app/view/formulario_admin_view.php" class="btn btn-primary">Registrar usuarios</a>
                </div>
            </div>
        </div>
    </div>
